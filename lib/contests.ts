...
export interface Contest {
  ...
  hint: string
  /**
   * Рядок про призи і короткий підзаголовок — для окремої сторінки
   * конкурсу, на яку веде QR у газеті.
   *
   * УВАГА: ті самі суми написані ще й у текстах умов на /konkursy.
   * Поки той файл не переведено на цей довідник, змінюючи суму, треба
   * правити ДВА місця. Розійдуться — виграє надрукована в газеті.
   */
  prizes: string
  tagline: string
  /**
...
export const CONTESTS: Contest[] = [
  {
    ...
    prizes: 'Головна нагорода 20 000 ₴',
  ...
  },
  {
    ...
    prizes: 'Перше місце — 4 000 ₴, друге — 2 500 ₴, третє — 1 500 ₴',
  ...
  },
  {
    ...
    prizes: 'Перше місце — 3 000 ₴, друге — 2 000 ₴, третє — 1 000 ₴',
