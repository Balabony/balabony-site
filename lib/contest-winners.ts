 ...
 * дату лише Тетяна Біденко; Aurelius Odel і Шевченко в базі не знайдені.
 */
...
export const AWARDS: Award[] = [
  ...
  // 18.09.2026: авторка попросила не показувати справжнє ім'я — лише псевдонім
  // (право з правил конкурсів: «Автор може попросити не називати справжнє ім'я»).
  { contest: 'Зірковий старт-2025', place: 2, name: 'Aurelius Odel' },
