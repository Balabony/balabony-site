...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `Ukrainian grandfather in embroidered shirt, ${scene}, traditional Ukrainian village background, warm artistic illustration style, portrait shot, face and upper chest only, no hands visible, no arms, close-up portrait`
