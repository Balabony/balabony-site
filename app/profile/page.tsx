      ...
      <div style={{
        ...
        {profile?.referral_code && (
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            {/* Раніше тут стояло сухе «вам нарахується 50 балів» — цифра, яка
                нічого не означає. Тепер названо, що саме вона дає: 50 балів це
                рівно один голос у черзі на озвучення. Ланцюжок «покликав друга →
                проголосував → історію озвучили» був вибудуваний повністю, але
                ніде не сказаний уголос. */}
            <div style={{ fontSize: '0.85rem', color: '#8CA0B8', marginTop: '0.5rem', lineHeight: 1.7 }}>
              Надішліть це посилання тому, кому може сподобатися. Коли людина за ним
              зареєструється, вам нарахується {REFERRAL_POINTS.inviter} балів —
              це рівно <a href="/cherga" style={{ color: '#FAC775' }}>один голос</a> за
              те, яку історію озвучимо першою. Другові теж дістанеться {REFERRAL_POINTS.invited}.
              {' '}Посилання працює 90 днів: якщо він відкриє його сьогодні,
              а зареєструється за тиждень, воно все одно спрацює.
              {invited > 0
