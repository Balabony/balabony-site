...
const TOPICS = [
  ...
  'Історична проза',
  'Пригоди',
  // 17.09.2026: було «Казки для дітей» — назва, якої на сайті вже немає.
  // Розділ 16.09 перейменовано на «Казки на ніч» за виміром попиту, і
  // опитування лишалося єдиним місцем зі старою. Автор обирав тему, якої
  // не існує, а відповіді не зводилися з рештою статистики.
  'Казки на ніч',
]
