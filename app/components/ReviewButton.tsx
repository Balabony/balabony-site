...
export default function ReviewButton({
  ...
  return (
    <>
      ...
      >
        {/* Зірки на платформі не використовуємо (рішення 09.09.2026) —
            ні тут, ні в самому вікні відгуку. */}
        <span aria-hidden="true" style={{ fontSize: 15, lineHeight: 1 }}>
          {mine ? '✓' : '✎'}
        </span>
        {/* Лічильник відгуків і середню оцінку публічно НЕ показуємо
            (рішення Богдана 09.09.2026): відгуки бачить лише редакція в
            /admin/analytics. Автор, який побачив би під своїм твором «2,0 з 5»,
            може більше нічого не написати, а читач за низькою оцінкою просто
            не відкриє текст. Дані з сервера приходять — вони потрібні для
            стану «ви вже відгукувалися», — але на екран не виводяться. */}
