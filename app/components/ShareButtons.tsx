...
interface Props { url: string; title: string; storyId?: string; season?: number }
...
function WAIcon()     { return <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg> }
function ViberIcon()  { return <svg width="13" height="13" viewBox="0 0 32 32" fill="currentColor"><path d="M16 1C7.7 1 1 7.7 1 16s6.7 15 15 15 15-6.7 15-15S24.3 1 16 1zm5.3 20.7c-.5.5-1 .8-1.7.9-.4.1-.8 0-1.1-.2-1.4-.7-2.7-1.6-3.8-2.7-1.1-1.1-2-2.4-2.7-3.8-.3-.6-.4-1.2-.1-1.8.2-.4.5-.8.8-1.1l1-1c.3-.3.7-.3.9 0l1.5 1.9c.2.3.2.7-.1.9l-.7.7c-.1.1-.1.3 0 .4.5.9 1.2 1.6 2 2.1.1.1.3.1.4 0l.7-.7c.3-.3.7-.3.9-.1l1.9 1.5c.3.3.3.7 0 1l-.9.9z"/></svg> }
function IGIcon()     { return <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg> }
...
const BTNS: BtnDef[] = [
  ...
  { label: 'Instagram', Icon: IGIcon,     href: ()     => `https://instagram.com/balabony_` },
  { label: 'TikTok',    Icon: TikTokIcon, href: (u)    => `https://www.tiktok.com/share?url=${u}` },
]

export default function ShareButtons({ url, title, storyId, season }: Props) {
