    ...
    <footer className="footer-root" style={{ background: 'var(--dark)', color: '#94a3b8', padding: '24px 5% 72px', marginTop: 24 }}>
      ...
      <div style={{
        ...
        <div>
          ...
          {/* 17.09.2026, аудит: сторінка «Як підписати договір» існувала без
              жодного внутрішнього посилання — її знаходив лише той, кому
              дали пряму адресу. Питання при цьому живе: автори питають про
              підписання щотижня. Місце тут, поряд зі «Стати автором»: хто
              дійшов до договору, уже пройшов цей крок. */}
          <a
            href="/yak-pidpysaty"
            className="footer-link"
            style={{
          ...
          {/* 18.09.2026: знаки зодіаку й письменницький гороскоп. Текст посилання
              стоїть на всіх сторінках сайту, тож несе пошуковий ключ «знаки
              зодіаку» (1–10 тис./міс), а не «письменницький гороскоп» (нуль). */}
          <a
            href="/znaky-zodiaku"
            className="footer-link"
            style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Balabony — українська літературна платформа: серіали з продовженням, історії письменників і казки для читачів різного віку. Проєкт розвиває <span style={{ color: 'var(--accent-gold)', fontWeight: 600 }}>ЛОГО «Інститут громадянського суспільства»</span> (Львів, з 2005 року) разом із видавничою групою «Життя», яка з 2003 року видає літературні газети сукупним накладом близько 1,56 млн примірників на рік. Ветерани, люди з інвалідністю та родини ВПО отримують повний доступ за 1 гривню на рік із підтвердженням статусу через «Дію» або за документом. Платформа побудована з урахуванням стандарту доступності WCAG 2.1 рівня AA. Аудіоверсії історій — у розробці.
        </p>
        <p style={{
