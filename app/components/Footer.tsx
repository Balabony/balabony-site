    ...
    <footer className="footer-root" style={{ background: 'var(--dark)', color: '#94a3b8', padding: '24px 5% 72px', marginTop: 24 }}>
      ...
      <div style={{
        ...
        <p style={{ marginBottom: 6 }}>
          © 2026 Balabony™. Соціальний проєкт ГО «Інститут громадянського суспільства» (ЄДРПОУ 33951844). Історії українською. Усі права захищено згідно із законодавством України.
        </p>
