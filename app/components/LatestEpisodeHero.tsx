...
export default function LatestEpisodeHero({ episode }: { episode: Episode }) {
  ...
  return (
    <section style={{ background: colors.bg, padding: '52px 20px' }}>
      <div style={{ maxWidth: 960, margin: '0 auto', display: 'grid', gridTemplateColumns: '380px 1fr', gap: 48, alignItems: 'center' }}>

        {/* Cover */}
        <div style={{ position: 'relative', borderRadius: 18, overflow: 'hidden', boxShadow: `0 8px 48px rgba(245,166,35,0.22), 0 2px 12px rgba(0,0,0,0.4)`, border: `1.5px solid ${GOLD}44`, flexShrink: 0 }}>
        ...
        <div>
          ...
          <h2 style={{ fontSize: 30, fontWeight: 800, color: colors.fg, fontFamily: FONT, lineHeight: 1.2, marginBottom: 14, margin: '0 0 14px' }}>
            {episode.title}
          </h2>
