...
export default function PwaSection() {
  ...
  return (
    <section className="pwa-section">
      {/* h3, а не h4: перед цим блоком на сторінці немає жодного h3, і
          пропущений рівень заголовка — єдине, що лишалося в доступності
          після правок 09.09.2026. Розмір задає .pwa-title, а не тег. */}
      <h3 className="pwa-title">Завжди під рукою</h3>
