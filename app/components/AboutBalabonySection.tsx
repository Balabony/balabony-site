 ...
 *  - 3 картки: Об'єднують / Навчають / Дають опору
 *  - Виділений блок: "сильна культура згуртовує націю" + аудіо тизер
 *  - 4 картки бенефіціарів (Родини ВПО / Ветерани / З інвалідністю / Пенсіонери) з SVG іконками
...
const MISSION = {
  ...
  functions: [
    {
      title: 'Обʼєднують',
      text: 'Тим, хто переходить з російської на українську, пропонуємо легкий шлях — без тиску й повчань. Прагнемо обʼєднати усіх українців навколо спільної мови, памʼяті та сміху.',
    },
    {
      title: 'Навчають',
    ...
    {
      title: 'Дають опору',
      text: 'Для тих, хто пережив війну, переселення чи довгу самотність, — знайома мова, тепло і сміх, які повертають відчуття дому.',
    },
  ],

  highlight: 'Ми віримо, що **сильна культура згуртовує націю** — і працюємо для того, щоб українці, де б вони не були, відчували себе частиною однієї спільноти й разом будували майбутнє України. Сьогодні ми пропонуємо читати, а скоро — слухати: озвучка історій у роботі.',
  ...
  beneficiaries: [
    ...
    {
      title: 'Ветерани',
      subtitle: 'Учасники бойових дій',
      iconType: 'shield' as const,
    },
    {
      title: 'З інвалідністю',
      subtitle: 'Зчитувач екрана і контраст',
      iconType: 'accessibility' as const,
    },
    {
      title: 'Пенсіонери',
      subtitle: 'Великий шрифт',
