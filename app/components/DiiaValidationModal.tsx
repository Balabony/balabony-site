        ...
        {step === 'code' && selected && (
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 18 }}>
              {[
                <>Візьміть телефон і відкрийте застосунок <b>Дія</b> (чорний значок із білим написом).</>,
          ...
          <>
            ...
            <label style={{
              ...
              <span style={{ fontSize: 13, color: '#475569', lineHeight: 1.5 }}>
                Даю згоду на обробку фото чи скану документа (він може містити дані про стан
                здоровʼя) лише для перевірки права на пільгу; після рішення редакції скан
                видаляється. Позначаючи статус, ви підтверджуєте достовірність даних. Якщо документ
