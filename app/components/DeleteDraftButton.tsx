 ...
 * випадково, а відновити текст, який автор вставив і не зберіг у себе, ми не
 * зможемо.
 */
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: '0.88rem', color: '#f5f0e8', lineHeight: 1.6, marginBottom: 10 }}>
        Видалити «{title}» назавжди? Текст не відновимо — якщо він потрібен,
        спершу скопіюйте його собі.
      </div>
