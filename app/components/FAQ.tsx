...
const ITEMS: { q: string; a: React.ReactNode }[] = [
  ...
  },
  {
    ...
    a: 'Для себе: 129 ₴/міс або 890 ₴/рік (вигідніше на 42%). Для родини: 199 ₴/міс або 1 390 ₴/рік на чотирьох. Пільговий тариф — 1 ₴/рік для УБД, ВПО та людей з інвалідністю (валідація через ДІЯ).',
  },
  {
