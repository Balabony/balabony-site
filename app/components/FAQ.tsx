...
const ITEMS: { q: string; a: React.ReactNode; plain?: string }[] = [
  {
    ...
    a: 'Понад 900 історій — усі відкриті, без реєстрації. Із серіалів: три перші серії кожного сезону плюс одна будь-яка серія на твій вибір у кожному сезоні.',
  },
  {
    q: 'Чи потрібна реєстрація?',
    a: 'Ні. Історії, три перші серії кожного сезону і твій вибір серії працюють одразу, без входу.',
  },
  {
    q: 'Що таке Балабони?',
    a: (
