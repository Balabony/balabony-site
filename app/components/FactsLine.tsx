...
export default function FactsLine({ initial }: { initial?: Stats } = {}) {
  ...
  // Скорочено 16.09.2026: «Налаштування для слабкого зору» в рядку з двох
  // коротких чисел займало три рядки на телефоні. Слово «налаштування»
  // нічого не додавало — важливе тут «для кого», а не «що саме».
  items.push('Для слабкого зору')
