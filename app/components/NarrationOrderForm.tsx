  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, marginBottom: 20 }}>
        Хочете аудіоверсію своєї книги чи серіалу? Озвучуємо професійними голосами, створеними на основі реальних дикторів. Залиште заявку — порахуємо вартість під ваш текст.
      </p>
