  ...
  return (
    <div style={{ background: t.card, border: `1.5px solid ${t.border}`, borderRadius: 16, padding: '28px' }}>
      ...
      <p style={{ fontSize: 15, color: t.body, lineHeight: 1.7, marginBottom: 20 }}>
        {/* 17.09.2026: тут стояло «запис із дикторами стартує у вересні 2026».
            Вересень настав, запису немає — та сама неправда, яку 09.09 вже
            прибрали зі сторінки /holosy. Дат більше не називаємо ніде: коштів
            на озвучення немає, і авторам ми сказали про це прямо. Форма
            лишається — заявки справді збираємо, це чесно. */}
        Хочете аудіоверсію своєї книги чи серіалу? Сьогодні платформа текстова: запис упирається не в бажання, а в гроші — студія, диктори, зведення. Дату не називаємо, поки не будемо певні, що витримаємо її. Заявки збираємо вже зараз: залиште свою, і ми порахуємо вартість під ваш текст, щойно з&apos;явиться фінансування.
      </p>
