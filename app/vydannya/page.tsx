...
export const metadata: Metadata = {
  ...
  description:
    'Перелік чинних і колишніх друкованих видань, з якими співпрацює платформа Балабони: газети «Життя», «Життя. Історії», «Життєві історії», «Найкращі жіночі історії», журнали «Коліжанка» та «Історії кохання».',
}
...
const VYDANNYA: Vydannya[] = [
  ...
  { name: 'Коліжанка', kind: 'журнал', status: 'chynne' },
  { name: 'Історії кохання', kind: 'журнал', status: 'chynne' },
]
