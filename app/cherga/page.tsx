  ...
  return (
    <main style={{ background: '#0a1628', minHeight: '100vh', padding: '1.5rem 1rem 4rem' }}>
      <div style={{ maxWidth: 780, margin: '0 auto' }}>
        ...
        {/* 17.09.2026: додано абзац про правило порядку. Доти сторінка
            пояснювала, як голосувати, але не казала, ЩО вирішує місце. Після
            переписування getQueue() тут видно й твори без голосів — і без
            пояснення список виглядав би випадковим. */}
        <p style={{ color: TEXT, lineHeight: 1.75, marginBottom: '0.9rem' }}>
          Порядок такий: спершу голоси, а серед творів із однаковою кількістю голосів
          вище стоїть той, кого більше дочитали. Голосів поки одиниці, тому черга
          майже повністю вишикувана за дочитуваннями — і кожен твір можна підняти
          своїм голосом із нуля. Від одного автора в списку не більше трьох творів.
        </p>
