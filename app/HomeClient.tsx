...
/**
 * Головна. Дані приходять готовими із серверної сторінки (app/page.tsx):
 * раніше вони тягнулися fetch'ем у браузері, і Google діставалася порожня
 * оболонка без назв, авторів і тизерів.
 */
export default function HomeClient({
  ...
  return (
    <ThemeProvider>
      ...
      {/* ПОРЯДОК ЗМІНЕНО 16.09.2026: історії авторів стоять ПЕРЕД серіалами.
          Раніше першими йшли «Балабони».
          Підстава: 988 історій від 107 авторів проти двох серіалів, які пише
          одна людина — власник платформи; історії відкриті всім і ведуть
          пошуковий трафік, тоді як серії під пейволом з четвертої.
          Ризик, який приймаємо свідомо: перша серія «Балабонів» — найбільш
          відкриваний матеріал на сайті (124 відкриття проти 26 у найкращої
          історії), тож загальні відкриття можуть просісти. Перевірити через
          два тижні на /admin/dochytuvannia. */}
      ...
      {/* Жанри стоять після історій і серіалів: спершу читач бачить, що є,
