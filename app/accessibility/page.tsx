        ...
        <main id="a11y-main-content" className="a11y-main" role="main">
          ...
          <section className="a11y-hero" aria-labelledby="hero-heading">
            ...
            <p className="a11y-hero-lead">
              Серіал «Балабони» — це десятки серій про живу українську мову,
              доступних кожному: слабкозорим, людям зі слуховими порушеннями, з дислексією,
              учасникам бойових дій, ВПО та людям з інвалідністю.
            </p>
          </section>
          ...
          <section className="a11y-features" aria-label="Функції доступності">
            ...
            <article className="a11y-card">
              <div className="a11y-card-icon" aria-hidden="true">✎</div>
              <h3>Текст (аудіо — у розробці)</h3>
              <p>Кожна серія доступна повним текстом; аудіоозвучення — у розробці. Текстовий формат — для людей зі слуховими порушеннями, тих, хто надає перевагу читанню, і для пошуку.</p>
            </article>
          </section>

          {/* ПРИКЛАДИ ДІАЛОГІВ */}
          <section className="a11y-section" aria-labelledby="dialog-heading">
            <h2 id="dialog-heading">Як виглядає текст серії</h2>
            <p className="a11y-section-lead">
              Кожна серія «Балабони» супроводжується повним текстом діалогу.
              Ось приклад трьох реплік з пілотної серії «Панасів вай-фай»:
            </p>
          ...
          <section className="a11y-inclusion" aria-labelledby="ubd-heading">
            ...
            <div>
              <h2 id="ubd-heading">Для учасників бойових дій, ВПО і людей з інвалідністю</h2>
              <p>
                Учасники бойових дій (УБД), ВПО та люди з підтвердженою інвалідністю отримують{' '}
              ...
              <p>
                Розширений доступ включає: усі серії, додаткові мовні
