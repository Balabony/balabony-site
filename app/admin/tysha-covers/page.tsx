        ...
        <section style={box}>
          ...
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 10 }}>
            {[
              ...
              ['У кузові', 'sitting in the back of a military truck, tired, grey daylight'],
              ['З рацією', 'holding a radio to his ear, looking to the side, smoke behind him'],
              ['Світанок, іній', 'at dawn, first light on his face, frost on his uniform'],
              ['Пов’язка', 'bandage on his head, exhausted but calm, ruined wall behind'],
              ['Сніг падає', 'winter, snow falling, breath visible in the cold air'],
              ['Окоп під дощем', 'in a muddy trench, rain, water dripping from his hair'],
              ['Біля стіни', 'leaning against a damaged concrete wall, dust in the air'],
              ['Каска під рукою', 'holding a helmet under his arm, sweat and dirt on his face'],
              ['Пожежа за спиною', 'silhouetted against a burning building, orange glow, serious look'],
              ['Ліс у сутінках', 'in a forest at dusk, fog between bare trees, alert expression'],
              ['Сам на уламках', 'sitting alone on rubble, head slightly lowered, grey overcast sky'],
              ['Курна буря', 'wind blowing, dust storm, squinting against the dust'],
              ['Бункер', 'inside a dark bunker, single weak light on his face'],
              ['Зруйнований міст', 'standing on a destroyed bridge, river and smoke behind'],
              ['Ранковий туман', 'early morning mist over an empty field, lonely figure'],
              ['Під дощем', 'rain-soaked, water running down his face, cold light'],
              ['Погляд у небо', 'looking up at the sky, distant explosions, tense face'],
              ['Після вибуху', 'covered in dust after an explosion, ringing-silence stare'],
              ['Зимовий ліс', 'winter forest, white snow, dark uniform, calm tired eyes'],
            ].map(([label, val]) => (
