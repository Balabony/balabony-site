...
/**
 * У прикладі не вигадані прізвища, а запрошення: жоден автор не має подумати,
 * що його обійшла неіснуюча людина.
 */
const demoRows = (n: number): Row[] =>
  Array.from({ length: n }, () => ({
    author: 'Тут може бути ваше прізвище',
    title: 'І назва вашого твору',
    slug: null,
  }))
