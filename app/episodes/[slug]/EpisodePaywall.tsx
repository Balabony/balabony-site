  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        >
          {isPremium ? 'Це бонусна серія. Вона доступна за річною передплатою або пільговим доступом.' : 'Безкоштовні серії цього сезону закінчилися. Обери цю серію як свою безкоштовну — або оформи передплату.'}
        </p> 
