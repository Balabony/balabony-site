...
const CHARACTERS = [
  ...
  'Віра', 'Галина Сергіївна', 'Зоя', 'Кандиба', 'Марфа', 'Степанич', 'Інститут', 'Василь', 'Роман', 'Вадим', 'Галина', 'Петро', 'Іван', 'Отець Павло', 'Христина', 'Губернатор', 'Галька', 'Даринка', 'Денис', 'Захар', 'Марія', 'Одарка', 'Оксана', 'Охрім', 'Тетяна', 'Юхим',
  'Дільничний Микола', 'Зять Віталій', 'Сусід Стьопа',
  'Баба Ганя', 'Баба Орися', 'Баба Мотря', 'Баба Параска', 'Баба Зоя',
  'Дід Панас', 'Онук Максим', 'Дід Оверко', 'Семен Кандиба',
]
