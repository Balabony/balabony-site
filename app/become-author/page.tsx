        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <SectionCard>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 16px' }}>
              ...
              <StepItem num={2}>
                Заповніть форму нижче: додайте одну пробну історію (файлом Word або текстом) і коротко дайте відповіді на кілька запитань про неї.
              </StepItem>
              <StepItem num={3}>
          ...
          <SectionCard>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <CheckItem>Оригінальний контент без плагіату. Штучний інтелект можна використовувати лише для перевірки правопису й граматики — сюжет, план, сцени й діалоги мають бути вашими</CheckItem>
