      ...
      >
        ...
        <section style={sectionStyle}>
          ...
          <p style={pStyle}>
            ...
            українців навколо рідної культури, де б вони не були, щоб разом
        ...
        <section style={sectionStyle}>
          ...
          <p style={pLastStyle}>
            Інклюзивна програма — безкоштовний доступ для пільгових категорій,
            підготовка та адаптація матеріалів для них — реалізується за
            грантової підтримки Львівської обласної громадської організації
