    ...
    <main style={{ padding: '2rem 1rem', background: BRAND.navy }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        {/* ТЕСТОВИЙ РЕЖИМ — НАЙПЕРШИЙ БЛОК КАБІНЕТУ (17.09.2026).
            ...
            Дата 23.11.2026 — та сама, що й старт передплати й озвучення.
            УВАГА: це НЕ дата конкурсних публікацій — ті стартують 25.11.2026
            і живуть окремо в lib/contests.ts.
        ...
        <div style={{
          ...
          <div style={{ color: '#e8eef7', lineHeight: 1.7, fontSize: '0.93rem' }}>
            Орієнтовна дата запуску — 23 листопада 2026 року. До того передплата
        ...
        <div style={{
          ...
          {/* РЕЙТИНГ АВТОРІВ ЗА ГОЛОСАМИ — З'ЯВЛЯЄТЬСЯ САМ (17.09.2026).
              ...
              при одному голосі на платформу вона показувала один рядок з
              одиницею і дев'ять з нулями — не рейтинг, а список тих, за кого
              не голосували, з автором у ньому.
              Поріг три автори з ненульовими голосами: дошка вмикається сама,
              коли голосування розійдеться. Повертати руками не доведеться —
              саме на цьому такі блоки й губляться. */}
          {authorVotes.filter(a => a.votes > 0).length >= 3 && (() => {
