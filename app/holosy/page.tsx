...
export const metadata: Metadata = {
  ...
  description:
    'Голоси, якими Балабони озвучуватимуть історії та серіали. Багатоголосе озвучення в розробці; читачі вже голосують, що озвучити першим.',
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          >
            ...
            <p style={{ fontSize: 15.5, lineHeight: 1.65, color: '#dbe4f0', margin: 0 }}>
              {/* 09.09.2026: тут стояло «запис заплановано на вересень 2026» —
                  вересень настав, запису немає. Дати більше не називаємо: коштів
                  на озвучення поки немає, і ми сказали про це авторам прямо.
                  Замість дати — те, на що читач може вплинути вже сьогодні. */}
              <strong style={{ color: '#f5f0e8' }}>Голосів поки немає.</strong> Сьогодні платформа текстова.
              Озвучення впирається не в бажання, а в гроші: студія, диктори, зведення. Щойно з’явиться
              фінансування — почнемо запис, і ця сторінка наповниться зразками. Дату не називаємо,
              поки не будемо певні, що витримаємо її.{' '}
              <Link href="/cherga" style={{ color: GOLD, fontWeight: 600 }}>
                Черга на озвучення
              </Link>{' '}
              — читачі вже голосують за те, що ми озвучимо першим. Нижче — голоси, які готуємо,
              і те, для чого кожен призначений.
            </p>
          </div>
