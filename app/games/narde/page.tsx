  ...
  return (
    <main lang="uk" style={wrap}>
      <div style={inner}>
        ...
        <details style={detailsBox} className="bb-details">
          <summary style={summaryStyle}>Поради початківцю</summary>
          <div style={detailsBody}>
            <p><b>Виводьте шашки з голови раніше.</b><br />За хід із голови сходить лише одна шашка. Якщо зволікати, решта 14 застрягнуть — починайте виводити їх змалку партії.</p>
            <p><b>Перекривайте сусідні пункти.</b><br />На пункт із вашою шашкою суперник стати не може. Кілька своїх пунктів поспіль звужують йому проходи й сповільнюють.</p>
            <p><b>Ведіть шашки рівномірно.</b><br />Виносити можна лише коли всі 15 удома. Не лишайте «відсталих» — одна забута шашка затримає все винесення.</p>
            <p><b>Великі числа — на довгі переходи.</b><br />5 і 6 витрачайте на далекі ходи, а малими 1–2 зручно доводити шашки до потрібних пунктів.</p>
            <p><b>Дубль — це чотири ходи.</b><br />Не поспішайте: дубль часто дозволяє і вивести шашку з голови, і добряче просунутися.</p>
            <p><b>Не засмучуйтесь через кубики.</b><br />Нарди — гра випадковості. Програти партію — нормально; грайте спокійно й у задоволення.</p>
          </div>
        </details>
