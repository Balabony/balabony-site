...
export const metadata: Metadata = {
  title: 'Доміно онлайн проти комп’ютера — безкоштовно | Балабони',
  description: 'Класичне центрове доміно проти комп’ютера, три рівні. Підрахунок очок і планування ходів.',
  alternates: { canonical: '/games/domino' },
  openGraph: {
    title: 'Доміно онлайн проти комп’ютера — безкоштовно | Балабони',
    description: 'Класичне центрове доміно проти комп’ютера, три рівні. Підрахунок очок і планування ходів.',
