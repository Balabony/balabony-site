    ...
    <main lang="uk" style={{ minHeight: '100vh', background: `linear-gradient(180deg, ${NAVY} 0%, ${NAVY2} 50%, ${NAVY} 100%)`, padding: '32px 5% calc(120px + env(safe-area-inset-bottom, 0px))', fontFamily: "'Montserrat', sans-serif", color: '#fff' }}>
      <div style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        <p style={{ color: TEXT_SOFT, fontSize: 16.5, lineHeight: 1.6, margin: '0 0 26px' }}>
          <b style={{ color: GOLD }}>Що це тренує.</b> Здатність гальмувати автоматичну
        ...
        <details style={detailsBox} className="bb-details">
          ...
          <div style={detailsBody}>
            <p><b>Що тренує.</b> Гальмівний контроль — здатність притлумити автоматичну, звичну реакцію (прочитати слово) і виконати потрібну дію (назвати колір). Це одна з основ уваги, зосередженості й самовладання.</p>
            <p><b>Звідки ця вправа.</b> Її придумав психолог Джон Рідлі Струп ще у 1935 році (звідси й назва — «тест Струпа»). Суть проста, але хитра: коли назву кольору написано іншим кольором, мозок за звичкою прагне <i>прочитати</i> слово — і доводиться зусиллям волі назвати саме колір літер. Уміння притлумити таку автоматичну реакцію й називають гальмівним контролем.</p>
            <p><b>Що показують дослідження.</b> Тренування таких завдань покращує цю здатність у людей похилого віку: наприклад, у Канаді (2019) комп’ютерне тренування значуще покращило показники в дорослих 65–85 років, а огляди досліджень підтверджують вплив подібних вправ на виконавчі функції (увагу, самоконтроль, перемикання).</p>
            <p className="bb-cream-note"><b>Чесно про користь.</b> Гра покращує саме <i>гальмівний контроль та увагу</i> — це підтверджено дослідженнями. Сприймайте її як корисну вправу для уваги, а не як ліки; вона не замінює лікування чи консультацію лікаря.</p>
            <p><b>Як грати найкраще.</b> Користь дає регулярність — короткі заняття кілька разів на тиждень. Спершу мозок «спотикається» об звичку читати — це нормально й саме в цьому сенс вправи.</p>
          </div>
        </details>
        ...
        <details style={detailsBox} className="bb-details">
          ...
          <div style={detailsBody}>
            <p><b>Кому підійде.</b> Будь-якому дорослому, хто хоче тренувати увагу й самоконтроль — і у зрілому віці, і під час відновлення. Потрібне розрізнення кольорів; якщо є дальтонізм, гра може бути незручною (орієнтуйтеся й на кружечок-підказку біля назви).</p>
            <p><b>Скільки за раз.</b> 5–10 хвилин, не до втоми. Одне коло — 12 запитань.</p>
            <p><b>Як часто.</b> 3–5 разів на тиждень короткими сеансами; кілька тижнів поспіль дають помітніший результат.</p>
            <p><b>Якщо складно.</b> Почніть із «Легкого» (3 кольори). Плутати слово й колір на початку — звична річ, з практикою стає легше.</p>
