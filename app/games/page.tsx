...
const EVIDENCE: Game[] = [
  { href: '/games/flash', kind: 'flash', title: 'Що промайнуло?', desc: 'Тренує швидкість сприйняття. Вправа з дослідження ACTIVE (Національні інститути здоров’я США) — єдиного, де тренування дало тривалий ефект.' },
  { href: '/games/attention', kind: 'attention', title: 'Подвійна увага', desc: 'Вчить утримувати увагу на двох речах одразу — це і є вправа на розділену увагу з дослідження ACTIVE.' },
]
const USEFUL: Game[] = [
  ...
  { href: '/games/digits', kind: 'digits', title: 'Цифри навпаки', desc: 'Запамʼятайте ряд цифр і введіть його у зворотному порядку — вправа за зразком цифрового ряду зі шкал Векслера.' },
  { href: '/games/fluency', kind: 'fluency', title: 'Назви якнайбільше', desc: 'Називайте вголос якнайбільше слів на тему чи літеру за хвилину. Словесна побіжність — те, що психологи використовують як один із показників у своїх обстеженнях.' },
