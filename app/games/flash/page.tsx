  ...
  return (
    <main lang="uk" style={{ minHeight: '100vh', background: `linear-gradient(180deg, ${NAVY} 0%, ${NAVY2} 50%, ${NAVY} 100%)`, padding: '32px 5% calc(120px + env(safe-area-inset-bottom, 0px))', fontFamily: "'Montserrat', sans-serif", color: '#fff' }}>
      <div style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        <p style={{ color: TEXT_SOFT, fontSize: 16.5, lineHeight: 1.6, margin: '0 0 26px' }}><b style={{ color: GOLD }}>Що це дає.</b><br />У дослідженнях люди, які тренувалися,
        ...
        <details style={detailsBox} className="bb-details">
          ...
          <div style={detailsBody}>
            <p><b>Що це за методика.</b><br />В основі — тренування «швидкості обробки» (speed of processing) з елементом розділеної уваги: треба швидко помітити й розпізнати зорову інформацію, що з’являється на короткий час. Методику розробили ще у 1990-х (тест Useful Field of View).</p>
            <p><b>На чому ґрунтується.</b><br />Дані взяті з дослідження ACTIVE — найбільшого у США дослідження різних типів когнітивного тренування в дорослих. Воно стартувало у 1998–1999 роках, охопило 2 802 особи віком від 65 років; учасників випадково розподілили на групи: тренування пам’яті, мислення, швидкості обробки або контрольну групу. Кожна група мала до 10 занять по 60–75 хвилин протягом 5–6 тижнів, частина — повторні («бустерні») сесії. Результати опубліковано у лютому 2026 року в журналі «Alzheimer’s &amp; Dementia: Translational Research &amp; Clinical Interventions».</p>
            <p><b>Що саме виявили.</b><br />Через 20 років у групи, яка тренувала швидкість і мала повторні сесії, виявили на 25% менше діагнозів деменції, ніж у контрольній — це був єдиний тип тренування з таким тривалим ефектом. На 10-му році ця ж група мала на 29% нижчу захворюваність. Раніші результати показували також менше труднощів у повсякденних справах і менше ДТП.</p>
            <p><b>Чому це працює.</b><br />Дослідники вважають, що тренування швидкості було особливо дієвим саме тому, що воно адаптивне — складність підлаштовувалася під рівень кожної людини. Тому й тут показ коротшає поступово, під ваш темп.</p>
            ...
            <p><b>Що дає регулярне тренування — простими словами.</b><br />Мозок звикає «схоплювати» побачене швидше. На практиці це означає швидшу реакцію, легкість у повсякденних справах (читання, орієнтування, дрібні рішення), упевненіше відчуття за кермом — а в дослідженні ця користь трималася роками. Коротко: тренуєте те, як швидко й чітко мозок обробляє те, що бачать очі.</p>
            <p className="bb-cream-note"><b>Чесні межі.</b><br />Ефект був лише у тих, хто тренувався <i>і</i> ходив на повторні сесії — отже, працює регулярність, а не одна спроба. Діагнози рахували за медичними записами (наближена оцінка). Це <i>зв’язок</i>, а не обіцянка результату для конкретної людини. Одна зі співавторок пов’язана з компанією, що продає комерційну версію тренажера (кажемо це для прозорості). Наша гра — <b>не сертифікований медичний тренажер</b>, а проста вправа за тим самим принципом, і вона не замінює лікування чи реабілітацію.</p>
        ...
        <details style={detailsBox} className="bb-details">
          ...
          <div style={detailsBody}>
            ...
            <p><b>Коли краще.</b><br />Коли ви бадьорі й спокійні, наприклад удень. Не варто грати геть втомленим або перед сном.</p>
