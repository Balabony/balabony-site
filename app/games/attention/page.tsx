    ...
    <main lang="uk" style={{ minHeight: '100vh', background: `linear-gradient(180deg, ${NAVY} 0%, ${NAVY2} 50%, ${NAVY} 100%)`, padding: '32px 5% 64px', fontFamily: "'Montserrat', sans-serif", color: '#fff' }}>
      <div style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        <p style={{ color: TEXT_SOFT, fontSize: 16.5, lineHeight: 1.6, margin: '0 0 26px' }}>
          <b style={{ color: GOLD }}>Чому саме так.</b> Дивитися в центр і водночас помічати
        ...
        <details style={detailsBox} className="bb-details">
          ...
          <div style={detailsBody}>
            <p><b>Що це за вправа.</b> «Подвійна увага» тренує розділену увагу й швидкість сприйняття: треба впізнати об’єкт у центрі й одночасно помітити, де з’явився об’єкт скраю. Саме така «гра на розділену увагу» (на основі тесту Useful Field of View, розробленого ще у 1990-х) використовувалася в дослідженні ACTIVE.</p>
            <p><b>На чому ґрунтується.</b> ACTIVE — найбільше у США дослідження різних видів когнітивного тренування. Воно стартувало у 1998–1999 роках, охопило 2 802 особи віком від 65 років; учасників випадково розподілили на групи: тренування пам’яті, мислення, швидкості з розділеною увагою або контрольну групу. Кожна група мала до 10 занять по 60–75 хвилин протягом 5–6 тижнів, частина — повторні («бустерні») сесії. Результати опубліковано у лютому 2026 року в журналі «Alzheimer’s &amp; Dementia: Translational Research &amp; Clinical Interventions».</p>
            <p><b>Що саме виявили.</b> Через 20 років у групи, яка тренувала швидкість із розділеною увагою й мала повторні сесії, виявили на чверть (на 25%) менше діагнозів деменції, ніж у контрольній — це був єдиний тип тренування з таким тривалим ефектом. На 10-му році ця ж група мала на 29% нижчу захворюваність. Раніші результати показували також менше труднощів у повсякденних справах і менше дорожніх пригод.</p>
            <p><b>Чому це працює.</b> Дослідники вважають, що вправа була особливо дієвою, бо вона адаптивна (підлаштовується під рівень людини), показує інформацію дуже коротко й тренує автоматичну навичку, а не завчені факти. Тому й тут показ коротшає поступово, під ваш темп.</p>
        ...
        <details style={detailsBox} className="bb-details">
          ...
          <div style={detailsBody}>
            ...
            <p><b>Якщо складно.</b> Це нормально — почніть із «Легкого» рівня. Подвійна увага складніша за просте впізнавання, тож не засмучуйтеся помилкам: саме невеликий виклик і тренує мозок.</p>
