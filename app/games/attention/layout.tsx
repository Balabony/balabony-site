...
export const metadata: Metadata = {
  title: 'Подвійна увага — гра для мозку | Балабони',
  description: 'Вправа на розділену увагу з дослідження ACTIVE: утримувати увагу на двох речах одразу. Безкоштовно, без реєстрації.',
  alternates: { canonical: '/games/attention' },
  openGraph: {
    title: 'Подвійна увага — гра для мозку | Балабони',
    description: 'Вправа на розділену увагу з дослідження ACTIVE: утримувати увагу на двох речах одразу. Безкоштовно, без реєстрації.',
