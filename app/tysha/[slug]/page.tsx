...
export default async function TyshaEpisodePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    ...
    >
      ...
      {ep.cover_url && (
        <div style={{ position: 'relative', maxWidth: 460, margin: '14px auto 0', aspectRatio: '3 / 4', overflow: 'hidden', borderRadius: 6, border: `2px solid ${GOLD}`, boxShadow: `0 0 18px ${GOLD}33` }}>
