...
export const metadata: Metadata = {
  ...
  description:
    'Найпопулярніші українські історії, казки й серіали на Балабонах: найчитаніше за весь час, улюблене читачами та нові твори, які вже читають.',
