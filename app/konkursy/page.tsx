...
const PYAT_VECHORIV: ShortContest = {
  ...
  scoring: [
    ...
    },
    {
      ...
      note: 'сюжет, гачок, мова, композиція, характери, сила фіналу. При однаковій сумі балів перемагає той, у кого більше дочитувань останньої серії.',
    },
  ],
  rules: [
...
const REVISION_NOTE =
  ...
  'до роботи платформи, у конкурсах участі не беруть. ' +
