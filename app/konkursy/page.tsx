...
const PYAT_VECHORIV: ShortContest = {
  ...
  dates: [
    ...
    ['Публікація серій', '4–18 листопада, щовівторка і щоп’ятниці о 18:00'],
    ['Підрахунок', '18–24 листопада 2026'],
    ['Оголошення переможців', '25 листопада 2026'],
    ['Озвучення фіналістів', 'грудень 2026'],
  ],
  scoring: [
    {
      weight: '100%',
      label: 'Дочитування',
      note: 'переможця обирає не журі, а читачі. Ми рахуємо, скільки людей дочитали серію до кінця, і складаємо цей показник по всіх п’яти серіях. Не перегляди й не лайки — саме дочитування. Один читач дає один бал на день, тож накрутити знайомими неможливо.',
    },
  ],
  rules: [
    ...
    'Надсилати на nazar@balabony.com.',
  ],
}
      ...
      {c.scoring && (
        <>
          ...
          <p style={{ ...para, fontSize: 14.5, color: A.quiet, marginTop: 12 }}>
            При однаковій сумі балів перемагає той, у кого вища доходимість останньої серії — хто
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '36px 20px calc(88px + env(safe-area-inset-bottom, 0px))' }}>
        ...
        <Section num="5" title="Як визначаємо переможця">
          ...
          <p style={{ ...P, margin: '14px 0 0', color: MUTED }}>
            Місця рухаються щодня: рейтинг перераховується за прочитаннями протягом усього конкурсу.
          </p>
        </Section>
