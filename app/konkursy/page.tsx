    ...
    scoring: [
      {
        weight: '100%',
        label: 'Оцінка редакції',
        note: 'казку читає редакція — п’ятеро редакторів. Роботи розподіляються по авторах: кожного автора читає один редактор, він і виставляє бал. Редактор бачить номер роботи й назву, а не прізвище. Оцінки окремих редакторів не розголошуються; у підсумках публікується лише середній бал.',
      },
      {
        weight: '—',
        label: 'Дочитування',
