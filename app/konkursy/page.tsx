...
const SHORT_CONTESTS: ShortContest[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Тексти, згенеровані штучним інтелектом, не приймаються. Перевірка правопису й добір синонімів порушенням не є. За сумнівів автор має змогу їх зняти — показати чернетки, історію правок, пояснити задум. Ілюстрації через ШІ дозволені: заборона стосується тексту.',
      'Права передаються як виключні, на три роки з дати прийняття кожного твору — як і для будь-якого твору на платформі. Виняток: власні ресурси автора (ваша сторінка, блог, канал), якщо доступ безоплатний і ви даєте посилання на платформу.',
