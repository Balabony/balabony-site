...
const SHORT_CONTESTS: ShortContest[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Казки не мають бути доступні на інших літературних платформах та в електронних бібліотеках на момент подачі. Публікація у вашому блозі, соцмережах чи в паперовому виданні участі не заважає.',
      ...
      'Плагіат — єдина підстава зняти роботу з конкурсу на будь-якому етапі; винагорода в такому разі повертається.',
