...
const REVISION_NOTE =
  ...
  'у конкурсі «Це довга історія» знято обмеження кількості учасників — попередня редакція ' +
  'передбачала два місця на кожен день тижня; розклад приведено у відповідність до правила про власний день ' +
  'тижня: серії виходять до 2 лютого 2027, дочитування зараховуються до 23 лютого, підсумки ' +
  '3 березня, виплати до 12 березня 2027; в умовах конкурсів «Один день, який усе змінив» ' +
  'і «З вітерцем» названо мінімальний обсяг 300 слів, який форма подачі перевіряла й раніше; ' +
  'у конкурсі «Це довга історія» описано третю нагороду з озвученням — «Найчитаніший», ' +
  'за найбільшу кількість зарахованих дочитувань; підсумковий протокол підписують усі редактори, ' +
  'що оцінювали роботи конкурсу, — попередня редакція називала фіксовану кількість у три особи; ' +
  'описано, як дочитування переводяться в бали: за місцем серед робіт, що подолали поріг, від 50 до 25; ' +
  'у конкурсах «Один день, який усе змінив» і «З вітерцем» дочитування тепер зараховуються 30 днів від виходу ' +
  'кожного твору, а не до спільної дати, щоб місце не залежало від того, кого опублікували раніше. ' +
