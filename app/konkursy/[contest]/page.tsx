    ...
    <main style={{ background: NAVY_DEEP, color: CREAM, fontFamily: FONT, minHeight: '100vh' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '30px 20px calc(80px + env(safe-area-inset-bottom, 0px))' }}>
        ...
        <div style={{
          ...
          {/* ДВА ТЕКСТИ, А НЕ ОДИН (17.09.2026).

              Абзац був однаковий для всіх конкурсів і стверджував, що половину
              оцінки дають дочитування, а поріг допуску — {c.threshold}. У
              казковому конкурсі це неправда двічі: оцінює лише редакція, а
              порога немає взагалі (threshold: 0). Сторінка суперечила власним
              умовам на відстані одного натискання — саме той тип розбіжності,
              через який автор перестає вірити правилам. */}
          <p style={{ fontSize: 13.5, lineHeight: 1.65, color: MUTED, margin: '18px 0 0' }}>
            {c.threshold > 0 ? (
              ...
              <>
                Підсумкову оцінку виставляє редакція. Порога допуску в цьому конкурсі
                немає: дочитування на місце в десятці не впливають і вирішують лише
                окрему відзнаку читачів.
              </>
            )}
          </p>
        ...
        <p style={{ fontSize: 13.5, color: MUTED, margin: '22px 0 0', textAlign: 'center' }}>
          <Link href="/konkursy" style={{ color: GOLD_SOFT }}>Усі конкурси Балабонів</Link>
        </p>
      </div>
    </main>
  )
