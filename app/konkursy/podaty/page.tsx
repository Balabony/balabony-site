...
const STEPS: { title: string; text: string }[] = [
  {
    ...
    text: 'Заявку приймаємо від автора, який увійшов: так ми точно знаємо, хто подав, і надсилаємо підтвердження на вашу пошту. Вхід без пароля — через Google або за посиланням із листа.',
  },
  {
    title: 'Попросіть читачів увійти',
    text: 'У конкурсний залік ідуть лише прочитання читачів, які увійшли на сайт. Вхід займає хвилину: пошта й код із листа, без пароля, або Google. Ділитися твором найкраще кнопкою «Поділитися» в кабінеті — у ній ваше особисте посилання.',
  },
  {
