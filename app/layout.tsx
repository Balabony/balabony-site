...
export const metadata: Metadata = {
  ...
  description: 'Читати та слухати українські оповідання, казки й серіали онлайн. Понад 990 історій українських авторів. Соціальний тариф 1 ₴ на рік для ветеранів, людей з інвалідністю та родин ВПО.',
