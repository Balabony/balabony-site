...
export const metadata: Metadata = {
  ...
  description: 'Український літературний простір. Пільговий тариф для родин ВПО, ветеранів (УБД) та людей з інвалідністю — соціальний проєкт ЛОГО «Інститут громадянського суспільства» (ЄДРПОУ 33951844).',
