...
export const metadata: Metadata = {
  ...
  description: 'Українські історії, серіали й казки для всієї родини. Соціальний тариф 1 ₴ на рік для ветеранів, людей з інвалідністю та родин ВПО — верифікація через Дію.',
