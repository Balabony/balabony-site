    ...
    <main style={{ background: NAVY, minHeight: '100vh', padding: '40px 20px 88px', fontFamily: SANS, color: CREAM }}>
      <div style={{ maxWidth: 820, margin: '0 auto', lineHeight: 1.7 }}>
        ...
        <p style={{ fontSize: '1.05rem' }}>
          ...
          альбомний і книжковий. Скачуються окремо, беріть той, який стане на
          ваше місце.
        </p>

        {/* ── Альбомний ─────────────────────────────────────── */}
        <div style={box}>
          <h2 style={{ ...h2, margin: '0 0 .6rem' }}>Альбомний — упоперек аркуша</h2>
          ...
          <p style={{ margin: '0 0 .6rem' }}>
            ...
            наших макетів — аркуш читається з двох-трьох метрів, тому його є сенс
            вішати не тільки перед собою, а й на стіну кабінету, у майстерні
            чи в класі.
          </p>
        ...
        {/* ── Книжковий ─────────────────────────────────────── */}
        <div style={box}>
          <h2 style={{ ...h2, margin: '0 0 .6rem' }}>Книжковий — упродовж аркуша</h2>
          ...
          <p style={{ margin: '0 0 .6rem' }}>
            ...
            формат для офісного принтера — друкується, нічого не перемикаючи.
          </p>
        ...
        <p>
          ...
          між ними невелика — 14,9 проти 13,8. Якщо стіна широка, беріть
