...
export default function CookiesPage() {
  return (
    <>
      ...
      <p className="legal-meta">Редакція від 19 вересня 2026 року</p>
      ...
      <ul>
        <li><strong>Google Analytics / gtag</strong> — допомагає нам розуміти, які історії читають, де люди натрапляють на труднощі та що виправити. Збирає знеособлені дані: тип пристрою, країну, поведінку на сторінці. За вашою згодою Google може зв&apos;язувати відвідування з вашим обліковим записом Google, щоб показати нам узагальнену демографію аудиторії (Google Signals).</li>
