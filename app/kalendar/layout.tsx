...
export const metadata: Metadata = {
  title: 'Календарі від Балабонів — роздрукувати безкоштовно',
  description: 'Календарі та планувальники від Балабонів: роздрукувати на А4 вдома, безкоштовно. Дитячий, настінний і на одному аркуші.',
